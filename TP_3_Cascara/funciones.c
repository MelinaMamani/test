    ...
    if(indice == -1){
        ...
        if(esta != -1)
        {
            ...
            system("pause");
                   ...
                   while(strlen(nuevaPelicula->genero)>19){
                   ...
                   while(strlen(nuevaPelicula->descripcion)>249){
                   ...
                   while(strlen(nuevaPelicula->linkImagen)>249){
            ...
            printf("\nLa pelicula %s no se encuentra en el sistema\n\n", nombre);
              ...
              switch(submenuMod()){
                ...
                case 1:
                   ...
                   while(strlen(modPelicula->titulo)>19){
                ...
                case 2:
                   ...
                   while(strlen(modPelicula->genero)>19){
                           printf("Reingrese genero: ");
                           fflush(stdin);
                           gets(modPelicula->genero);
                   }
                ...
                case 4:
                   ...
                   while(strlen(modPelicula->descripcion)>249){
                           printf("Reingrese descripcion: ");
                           fflush(stdin);
                           gets(modPelicula->descripcion);
                   }
                ...
                case 6:
                   ...
                   while(strlen(modPelicula->linkImagen)>249){
                           printf("Reingrese link: ");
                           fflush(stdin);
                           gets(modPelicula->linkImagen);
                   }
